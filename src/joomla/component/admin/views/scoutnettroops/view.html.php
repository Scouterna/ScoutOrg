...
class ScoutOrgViewScoutnetTroops extends JViewLegacy {
    /**
	...
	private function addToolbar() {	
		...
		JToolBarHelper::addNew('scoutnettroop.add');
		JToolBarHelper::editList('scoutnettroop.edit');
		JToolBarHelper::deleteList('', 'scoutnettroops.delete');
	}
}